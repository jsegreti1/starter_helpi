...
// Array of answer choices corresponding to each prompt
const CHOICES = [
...
// Define props for BasicQuestions component
...
export function BasicQuestions({ apiKey }: BasicQuestionsProps): JSX.Element {
  ...
  // Update current answer based on user selection
  ...
  if (!finished) {
    ...
    // Render the loading spinner while fetching GPT response
    if(loading){
      return(
